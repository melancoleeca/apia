...
class LabelFragmentString(var label: String, var property: Property<String>) : Fragment {
    ...
    private fun createRoot(): Component {
        ...
        return Components.hbox().withSize(width, 1).withSpacing(0).build().apply {
            ...
            addComponent(Components.label().withText(property.value).withSize(width/2, 1).build().apply {
